...
class MemberController(
    ...
    fun login(@RequestParam code: String): MemberProfileResDto {
        ...
        val oAuthTokenDto: OAuthTokenDto =
            oAuthServiceFactory.getOauthService(SocialType.KAKAO).getAccessToken(code)
        val oAuthMember: OAuthMember =
            oAuthServiceFactory.getOauthService(SocialType.KAKAO).getUser(oAuthTokenDto.accessToken)
